...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Translations = new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
    {
        ["es"] = new Dictionary<string, string>
        {
            ...
            ["History.ViewInfo"] = "Ver información",
            ["History.InfoTitle"] = "Información del registro",
            ["History.InfoBack"] = "← Volver al historial",
            ["History.InfoNotFound"] = "No se encontró este registro.",
            ["History.InfoCenter"] = "Centro",
            ["History.InfoAnomalies"] = "Anomalías",
            ["History.CopySuccess"] = "Código copiado al portapapeles.",
            ...
            ["Heatmap.BackToInfo"] = "← Volver a la información",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["History.ViewInfo"] = "View details",
            ["History.InfoTitle"] = "Record details",
            ["History.InfoBack"] = "← Back to history",
            ["History.InfoNotFound"] = "Record not found.",
            ["History.InfoCenter"] = "Center",
            ["History.InfoAnomalies"] = "Anomalies",
            ["History.CopySuccess"] = "Copied to clipboard.",
            ...
            ["Heatmap.BackToInfo"] = "← Back to record details",
        ...
        ["zh"] = new Dictionary<string, string>
        {
            ...
            ["History.Delete"] = "删除",
            ["History.ViewInfo"] = "查看详情",
            ["History.InfoTitle"] = "记录详情",
            ["History.InfoBack"] = "← 返回历史",
            ["History.InfoNotFound"] = "未找到记录。",
            ["History.InfoCenter"] = "中心点",
            ["History.InfoAnomalies"] = "异常",
            ["History.CopySuccess"] = "已复制到剪贴板。",
        ...
        ["fr"] = new Dictionary<string, string>
        {
            ...
            ["History.ViewInfo"] = "Voir les détails",
            ["History.InfoTitle"] = "Détails de l'enregistrement",
            ["History.InfoBack"] = "← Retour à l'historique",
            ["History.InfoNotFound"] = "Enregistrement introuvable.",
            ["History.InfoCenter"] = "Centre",
            ["History.InfoAnomalies"] = "Anomalies",
            ["History.CopySuccess"] = "Copié dans le presse-papiers.",
            ...
            ["Heatmap.BackToInfo"] = "← Retour aux détails",
        ...
        ["pt"] = new Dictionary<string, string>
        {
            ...
            ["History.ViewInfo"] = "Ver informações",
            ["History.InfoTitle"] = "Informações do registro",
            ["History.InfoBack"] = "← Voltar ao histórico",
            ["History.InfoNotFound"] = "Registro não encontrado.",
            ["History.InfoCenter"] = "Centro",
            ["History.InfoAnomalies"] = "Anomalias",
            ["History.CopySuccess"] = "Código copiado para a área de transferência.",
            ...
            ["Heatmap.BackToInfo"] = "← Voltar às informações",
